...
class Rectangle(Base):
    """a class represents a rectangle object"""
    ...
    def area(self):
        """Function  that gives the area of a rectangle"""
        return self.width * self.height

    def display(self):
        """Functon thta displays a rectangle"""
    ...
    def update(self, *args, **kwargs):
        """Function that update method that assigns an
    ...
    def to_dictionary(self):
        """Function that gives dictionary representation
        of rectangle"""
